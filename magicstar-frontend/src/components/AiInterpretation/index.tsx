    ...
    <View className={`ai-interpretation ${className}`}>
          ...
          {quality && (
            <View className='quality-badge'>
              <Text 
                ...
                style={{ color: getQualityColor(quality.score) }}
              >
                {quality.score}分
              </Text>
              <Text className='quality-grade'>
                {getQualityText(quality.grade)}
              </Text>
            </View>
          )}
        </View>
      ...
      {quality && (
        <View className='quality-section'>
          ...
          {quality.feedback && (
            <Text className='quality-feedback'>{quality.feedback}</Text>
          )}
        </View>
      )}
      ...
      <View className='metadata-section'>
        ...
        <Text className='metadata-text'>
          处理时间: {interpretation.metadata.processingTime}ms
        </Text>
        <Text className='metadata-text'>
          使用模型: {interpretation.metadata.modelUsed}
        </Text>
      </View>
    </View>
  )
